...
-- floaterm teggle
keymap("n", keys.floaterm_toggle, ":FloatermToggle<CR>")
keymap("n", keys.floaterm_new, ":FloatermNew<CR>")
keymap("n", keys.floaterm_prev, ":FloatermPrev<CR>")
keymap("n", keys.floaterm_next, ":FloatermNext<CR>")
